...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            ...
            df.to_csv(self.ingestion_config.raw_data_path,index=False,header=True)       # converted data into raw data
            ...
            return(
                self.ingestion_config.train_data_path,                                # returning train and test dat path for data transformation
